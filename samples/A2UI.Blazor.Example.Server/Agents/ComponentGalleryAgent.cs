...
/// <summary>
/// Example agent that renders all standard A2UI components as a gallery.
/// Useful for testing and demonstrating the component catalog.
/// </summary>
public sealed class ComponentGalleryAgent : IA2UIAgent
{
    ...
    public async Task HandleAsync(A2UIStreamWriter writer, CancellationToken cancellationToken)
    {
        ...
        components.Add(new ComponentBuilder("root", "Column")
            .Children("title", "subtitle", "divider-top",
                "display-section", "divider1",
                "input-section", "divider2",
                "layout-section")
            .Gap("16")
            .Build());

        components.Add(new ComponentBuilder("title", "Text").Text("A2UI Component Gallery").UsageHint("h1").Build());
        components.Add(new ComponentBuilder("subtitle", "Text").Text("All standard A2UI components rendered with Blazor WebAssembly").UsageHint("caption").Build());
        components.Add(new ComponentBuilder("divider-top", "Divider").Build());

        // --- Display section ---
        components.Add(new ComponentBuilder("display-section", "Card")
            .Title("Display Components")
            .Children("display-col")
            .Build());
        components.Add(new ComponentBuilder("display-col", "Column")
            .Children("text-h1", "text-h2", "text-body", "text-caption", "icon1", "divider-sample")
            .Gap("8")
            .Build());
        ...
        // --- Input section ---
        components.Add(new ComponentBuilder("input-section", "Card")
            .Title("Input Components")
            .Children("input-col")
            .Build());
        components.Add(new ComponentBuilder("input-col", "Column")
            .Children("btn-row", "textfield1", "checkbox1", "choice1", "datetime1", "slider1")
            .Gap("12")
            .Build());
        components.Add(new ComponentBuilder("btn-row", "Row")
            .Children("btn-primary", "btn-secondary", "btn-disabled")
            .Gap("8")
            .Build());
        ...
        // --- Layout section ---
        components.Add(new ComponentBuilder("layout-section", "Card")
            .Title("Layout Components")
            .Children("layout-col")
            .Build());
        components.Add(new ComponentBuilder("layout-col", "Column")
            .Children("row-demo", "tabs-demo")
            .Gap("12")
            .Build());
        components.Add(new ComponentBuilder("row-demo", "Row")
            .Children("row-item1", "row-item2", "row-item3")
        ...
        components.Add(new ComponentBuilder("tabs-demo", "Tabs")
            .Tabs(("Tab One", "tab1-content"), ("Tab Two", "tab2-content"))
            .Build());
    ...
    {
        // Gallery agent doesn't process actions; it's purely demonstrative
