...
/// <summary>
/// Example agent that demonstrates a contact lookup UI with data binding.
/// </summary>
public sealed class ContactLookupAgent : IA2UIAgent
{
    ...
    public async Task HandleAsync(A2UIStreamWriter writer, CancellationToken cancellationToken)
    {
        ...
        await writer.WriteUpdateDataModelAsync("contacts", "/", new
        {
        ...
        components.Add(new ComponentBuilder("root", "Column")
            .Children("header", "search-row", "divider", "contact-list")
            .Gap("12")
            .Build());

        components.Add(new ComponentBuilder("header", "Text").Text("Contact Directory").UsageHint("h2").Build());

        components.Add(new ComponentBuilder("search-row", "Row")
            .Children("search-input", "search-btn")
            .Gap("8")
            .Alignment("end")
            .Build());
        components.Add(new ComponentBuilder("search-input", "TextField")
            .Placeholder("Search contacts...")
            .Label("Search")
            .Action("search")
            .Build());
        components.Add(new ComponentBuilder("search-btn", "Button")
            .Label("Search")
            .Action("search")
            .Build());
        ...
        components.Add(new ComponentBuilder("contact-list", "List")
            .Data("/contacts")
            .Template("contact-row")
            .Build());
        components.Add(new ComponentBuilder("contact-row", "Row")
            .Children("contact-name", "contact-email", "contact-dept")
